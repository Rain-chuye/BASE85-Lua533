...
static int tcreate (lua_State *L) {
  lua_Integer sizeseq = luaL_optinteger(L, 1, 0);
  lua_Integer sizerest = luaL_optinteger(L, 2, 0);
  luaL_argcheck(L, sizeseq >= 0, 1, "out of range");
  luaL_argcheck(L, sizerest >= 0, 2, "out of range");
